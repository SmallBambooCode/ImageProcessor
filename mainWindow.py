...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font.setFamily("Agency FB")
        font.setPointSize(12)
        self.srcImageView.setFont(font)
        ...
        self.resetImageMenu.addAction(self.undoAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "数字图像处理工具箱V1.0"))
        self.srcImageLabel.setText(_translate("MainWindow", "原图预览"))
        self.outImageLabel.setText(_translate("MainWindow", "处理后的图片预览"))
        self.infoLabel.setText(_translate("MainWindow", "当前图像信息："))
        self.fileMenu.setTitle(_translate("MainWindow", "文件"))
        self.resetImageMenu.setTitle(_translate("MainWindow", "撤销"))
        ...
        self.undoAction.setText(_translate("MainWindow", "回到上一步"))
